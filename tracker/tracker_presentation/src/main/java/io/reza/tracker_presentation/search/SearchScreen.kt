...
import io.reza.tracker_presentation.search.component.SearchTextField
import io.reza.tracker_presentation.search.component.TrackableFoodItem
...
fun SearchScreen(
    ...
    Column(
        ...
        Text(
            text = stringResource(
                id = io.reza.core.R.string.add_meal, mealName
            ),
            ...
            items(state.trackableFoods) { food ->
                TrackableFoodItem(
                    ...
                    onTrack = {
                        keyboardController?.hide()
                        viewModel.onEvent(
                            SearchEvent.OnTrackFoodClicked(
                                food = food.food,
    ...
    Box(
        ...
        when {
            ...
            state.trackableFoods.isEmpty() -> {
                Text(
                    text = stringResource(id = io.reza.core.R.string.no_results),
